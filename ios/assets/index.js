...
var _httpHandler = __webpack_require__(6);

var _httpHandler2 = _interopRequireDefault(_httpHandler);

var _uris = __webpack_require__(8);
...
exports.default = {
  submitLogin: function submitLogin(params, success, fail) {
    var formData = '';
    for (var item in params.form) {
    ...
    _httpHandler2.default.post.bind(this)(_uris2.default.user.submitLogin, formData, success, fail, makeData);
  }
};
...
__vue_options__.__file = "/Users/zhulin/Desktop/workspace_h5/weex-hackernews-master/src/App.vue"
...
var _responseHandler = __webpack_require__(7);
...
exports.default = {
    get: function get(url, params, success, fail, makeData) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            ...
            stream.fetch({
                ...
                type: 'json'
            }, _responseHandler2.default.success(success, fail, makeData, _this), _responseHandler2.default.error(fail));
        });
    },
    post: function post(url, params, success, fail, makeData) {
        var _this2 = this;
        ...
        return new Promise(function (resolve, reject) {
            ...
            }, _responseHandler2.default.success(success, fail, makeData, _this2), _responseHandler2.default.error(fail));
        });
    }
};
...
var _errorMessage = __webpack_require__(5);
...
exports.default = {
  success: function success(_success, fail, makeData, vm) {
    return function (response) {
      ...
      try {
        ...
        if (data.resultCode === 100) {
          console.log('success');
          _success && _success(makeData ? makeData(data) : data);
        } else if (data.resultCode === 101) {
          _eventBus2.default.backUrl = vm.$route.path;
          ...
          console.log(_eventBus2.default.backUrl);
          var backUrl = _eventBus2.default.backUrl ? _eventBus2.default.backUrl : 'member-list';
          console.log(data.resultData.resultMsg);
          _eventBus2.default.backUrl = '';
          vm.$router.replace(backUrl);
        } else {
          console.log('fail');
          fail && fail(data.errorMessage || _errorMessage2.default[data.resultCode] || '未定义错误消息' + data.resultCode, data.resultCode);
        }
      } catch (e) {
...
__vue_options__.__file = "/Users/zhulin/Desktop/workspace_h5/weex-hackernews-master/src/views/login.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7b5cbdc8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/zhulin/Desktop/workspace_h5/weex-hackernews-master/src/views/register.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e88bb3d8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            _login2.default.submitLogin.bind(this)({ form: this.form }, function (data) {
                _this.message = data.resultData.resultMsg;
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            _login2.default.submitLogin.bind(this)({ form: this.form }, function (data) {
                _this.message = data.resultData.resultMsg;
                console.log(_this, message);
                _this.$router.replace('member-list');
            }, function (err) {
                _this.message = err;
                console.log(err);
            });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('h1', [_vm._v("登录")]), _c('div', [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("用户名")]), _c('input', {
    staticClass: ["input"],
    attrs: {
    ...
    on: {
      "input": function($event) {
        _vm.form.email = $event.target.attr.value
      }
    }
  })]), _c('div', [_c('text', {
    staticClass: ["label"]
    ...
    on: {
      "input": function($event) {
        _vm.form.pswd = $event.target.attr.value
      }
    }
  })]), _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h1', [_vm._v("登录45678764567")]), _c('div', [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("用户名")]), _c('input', {
    staticClass: ["input"],
    attrs: {
